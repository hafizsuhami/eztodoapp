                ...
                <div v-if="shareLink" class="space-y-3">
                  <div class="flex gap-2">
                    ...
                    <button
                      ...
                      :class="[
                        'px-3 py-2.5 rounded-xl font-medium transition-colors flex items-center justify-center',
                        copySuccess
                    ...
                    <button
                      ...
                      class="px-3 py-2.5 rounded-xl font-medium transition-colors flex items-center justify-center bg-[#25D366] hover:bg-[#20bd5a] text-white"
