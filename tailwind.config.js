...
export default {
  ...
  theme: {
    extend: {
      ...
      // World-class shadow elevation system (Stripe/Linear inspired)
      boxShadow: {
        ...
        'md': '0 4px 6px -2px rgb(0 0 0 / 0.05), 0 2px 4px -2px rgb(0 0 0 / 0.03)',
        'lg': '0 8px 16px -4px rgb(0 0 0 / 0.08), 0 4px 6px -4px rgb(0 0 0 / 0.03)',
        'xl': '0 16px 32px -8px rgb(0 0 0 / 0.1), 0 8px 16px -8px rgb(0 0 0 / 0.04)',
        '2xl': '0 24px 48px -12px rgb(0 0 0 / 0.15)',
        'inner': 'inset 0 1px 2px 0 rgb(0 0 0 / 0.04)',
        'primary-sm': '0 2px 8px -2px hsl(var(--primary) / 0.25)',
        'primary': '0 4px 14px -3px hsl(var(--primary) / 0.3)',
        'primary-lg': '0 8px 24px -4px hsl(var(--primary) / 0.35)',
      },
      ...
      // Animation timing functions (Stripe/Linear inspired)
